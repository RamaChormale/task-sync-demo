    ...
    <div className="overflow-x-auto rounded-xl border border-gray-200">
      <table className="w-full text-sm">
        <thead className="bg-gray-50 border-b border-gray-200">
          <tr>
            {['Title', 'Status', 'Sync', 'Issue #', 'Last Synced', 'Created', 'Actions'].map((h) => (
              ...
              <td className="px-4 py-3">
                <div className="flex items-center gap-1">
                  ...
                  {task.githubIssueNumber && (
                    <a
                      href={`https://github.com/${task.githubRepoOwner || import.meta.env.VITE_GITHUB_OWNER}/${task.githubRepo || import.meta.env.VITE_GITHUB_REPO}/issues/${task.githubIssueNumber}`}
                      target="_blank"
